    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='aflohap.topic')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aflohap.room')),
