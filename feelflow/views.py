...
from feelflow.forms import MyUserCreationForm, RoomForm, UserForm
from feelflow.models import Message, Room, Topic, User
...
with open('C:\\Users\\curveo\\Documents\\webapp\\feelflow\\naive_bayes_model.pkl', 'rb') as f:
    model = pickle.load(f)

with open('C:\\Users\\curveo\\Documents\\webapp\\feelflow\\vectorizer.pkl', 'rb') as f:
